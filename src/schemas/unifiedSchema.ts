...
export const UNIFIED_SCHEMAS: UnifiedFormSchema[] = [
  ...
  },
  {
    ...
    frequency: "On event",
    importance: "High",
    description: "Request for process change with impact analysis.",
    fields: [
      { key: "serial", label: "Serial Number", type: "text", required: true, width: "half", defaultValue: "auto" },
      { key: "date", label: "Date", type: "text", required: true, width: "half" },
      { key: "initiated_by", label: "Initiated By", type: "signature", required: true, width: "half" },
      { key: "change_type", label: "Change Type", type: "select", width: "half", options: ["Process", "Document", "System", "Organizational"] },
      { key: "description", label: "Change Description", type: "textarea", width: "full" },
      { key: "reason", label: "Reason for Change", type: "textarea", width: "full" },
      { key: "impact_analysis", label: "Impact Analysis", type: "textarea", width: "full" },
      { key: "risk_assessment", label: "Risk Assessment", type: "textarea", width: "full" },
      { key: "implementation_plan", label: "Implementation Plan", type: "textarea", width: "full" },
      { key: "reviewed_by", label: "Reviewed By", type: "signature", width: "half" },
      { key: "approved_by", label: "Approved By", type: "signature", width: "half" },
      { key: "status", label: "Status", type: "select", width: "half", options: ["Open", "Under Review", "Approved", "Rejected", "Implemented"] },
    ],
  },
  {
    code: "F/21",
    ...
    fields: [
      { key: "serial", label: "Serial Number", type: "text", required: true, width: "half", defaultValue: "auto" },
      { key: "date", label: "Date", type: "text", required: true, width: "half" },
      { key: "equipment_name", label: "Equipment Name", type: "text", required: true, width: "full" },
      { key: "equipment_id", label: "Equipment ID", type: "text", width: "half" },
      { key: "calibrated_by", label: "Calibrated By", type: "text", width: "full" },
      { key: "certificate_no", label: "Certificate No.", type: "text", width: "half" },
      { key: "next_due_date", label: "Next Due Date", type: "text", width: "half" },
      { key: "standard_used", label: "Standard Used", type: "text", width: "full" },
      { key: "results", label: "Results", type: "textarea", width: "full" },
      { key: "status", label: "Status", type: "select", width: "half", options: ["Pass", "Fail", "Out of Tolerance"] },
      { key: "remarks", label: "Remarks", type: "textarea", width: "full" },
      { key: "reviewed_by", label: "Reviewed By", type: "signature", width: "half" },
    ],
  },
  ...
  // ── Section 04: Quality & Audit ───────────────────────────────────────
  {
    ...
    frequency: "On event",
    importance: "High",
    description: "Audit checklist for internal/external audits.",
    fields: [
      { key: "serial", label: "Serial Number", type: "text", required: true, width: "half", defaultValue: "auto" },
      { key: "date", label: "Date", type: "text", required: true, width: "half" },
      { key: "audit_type", label: "Audit Type", type: "select", required: true, width: "half", options: ["Internal", "External", "Supplier"] },
      { key: "auditor", label: "Auditor", type: "text", required: true, width: "full" },
      { key: "auditee", label: "Auditee", type: "text", required: true, width: "full" },
      { key: "scope", label: "Scope", type: "text", width: "full" },
      { key: "items", label: "Checklist Items", type: "table", width: "full", columns: [
        { key: "srNo", label: "Sr. No.", type: "text", width: "full" },
        { key: "clause", label: "ISO Clause", type: "text", width: "full" },
        { key: "question", label: "Question", type: "text", width: "full" },
        { key: "evidence", label: "Evidence", type: "text", width: "full" },
        { key: "finding", label: "Finding", type: "select", width: "full", options: ["Conformity", "Non-Conformity", "Observation", "N/A"] },
        { key: "remarks", label: "Remarks", type: "text", width: "full" },
      ]},
      { key: "summary", label: "Summary", type: "textarea", width: "full" },
      { key: "auditor_signature", label: "Auditor Signature", type: "signature", required: true, width: "half" },
      { key: "auditee_signature", label: "Auditee Signature", type: "signature", width: "half" },
    ],
  },
  {
    code: "F/29",
    ...
    frequency: "On event",
    importance: "High",
    description: "Training attendance and evaluation record.",
    fields: [
      { key: "serial", label: "Serial Number", type: "text", required: true, width: "half", defaultValue: "auto" },
      { key: "date", label: "Date", type: "text", required: true, width: "half" },
      { key: "topic", label: "Training Topic", type: "text", required: true, width: "full" },
      { key: "trainer", label: "Trainer", type: "text", required: true, width: "full" },
      { key: "duration_hours", label: "Duration (Hours)", type: "number", width: "half" },
      { key: "participants", label: "Participants", type: "table", width: "full", columns: [
        { key: "srNo", label: "Sr. No.", type: "text", width: "full" },
        { key: "employee_name", label: "Employee Name", type: "text", width: "full" },
        { key: "employee_id", label: "Employee ID", type: "text", width: "full" },
        { key: "department", label: "Department", type: "text", width: "full" },
        { key: "attendance", label: "Attendance", type: "select", width: "full", options: ["Present", "Absent", "Partial"] },
        { key: "evaluation", label: "Evaluation", type: "text", width: "full" },
        { key: "result", label: "Result", type: "select", width: "full", options: ["Pass", "Fail", "Incomplete"] },
      ]},
