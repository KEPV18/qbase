...
export const FORM_SCHEMAS: FormSchema[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "root_cause_analysis", label: "Root Cause Analysis", type: "textarea", required: true, width: "full" },
      { key: "identified_date", label: "Identified Date", type: "date", required: true, width: "half" },
      { key: "identified_by", label: "Identified By", type: "text", required: true, width: "half" },
      { key: "actions_recommended", label: "Actions Recommended", type: "textarea", required: true, width: "full" },
      { key: "responsibility", label: "Responsibility", type: "text", required: true, width: "half" },
      { key: "actions_taken", label: "Actions Taken", type: "textarea", width: "full" },
      { key: "action_taken_date", label: "Action Taken Date", type: "date", width: "half" },
      { key: "action_taken_by", label: "Action Taken By", type: "text", width: "half" },
  ...
  },
  {
    ...
    importance: "Critical",
    description: "Semi-annual audit scheduling and planning with 4-column audit matrix, corporate mandate, and closure footer.",
    fields: [
      { key: "audit_plan_no", label: "Audit Plan No.", type: "text", required: true, width: "half", defaultValue: "auto" },
      { key: "date", label: "Date", type: "date", required: true, width: "half" },
      { key: "from_role", label: "From (Role)", type: "text", required: true, width: "half" },
      { key: "to_role", label: "To (Role)", type: "text", required: true, width: "half" },
      { key: "last_audit_month", label: "Last Audit Month", type: "text", width: "third" },
      { key: "last_audit_plan_no", label: "Last Audit Plan No.", type: "text", width: "third" },
      { key: "last_audit_plan_date", label: "Last Audit Plan Date", type: "text", width: "third" },
      { key: "next_audit_due_month", label: "Next Audit Due", type: "text", width: "half" },
      { key: "next_audit_plan_no", label: "Next Audit Plan No.", type: "text", width: "half" },
      { key: "intro_corporate_note", label: "Corporate Mandate", type: "textarea", required: true, width: "full" },
      { key: "audit_matrix", label: "Audit Matrix", type: "table", columns: [
        { key: "department", label: "Department", type: "text", required: true },
        { key: "activity_scope", label: "Audit All Activity / Part", type: "text", required: true },
        { key: "date_time", label: "Date And Time", type: "text", required: true },
        { key: "auditor", label: "Auditor", type: "text", required: true },
      ]},
      { key: "status_of_actual_audit", label: "Status Of Actual Audit", type: "text", required: true, width: "half" },
      { key: "remarks", label: "Remarks", type: "textarea", width: "full" },
  ...
  // ── Section 04: Procurement & Vendors ─────────────────────────────────
  {
    ...
    fields: [
      ...
      { key: "date", label: "Date", type: "date", required: true, width: "half" },
      { key: "vendor_name", label: "Vendor / To", type: "text", required: true, width: "full" },
      { key: "intro_statement", label: "Intro Statement", type: "text", required: false, width: "full" },
      { key: "items_table", label: "Items", type: "table", columns: [
      ...
      { key: "total_amount_rs", label: "Total Amount (Rs.)", type: "number", required: false, width: "half" },
      { key: "specifications", label: "Specifications", type: "textarea", required: false, width: "full" },
      { key: "as_per_clause", label: "As Per Clause", type: "text", required: false, width: "half" },
      { key: "supplies_notice", label: "Supplies Notice", type: "textarea", required: false, width: "full" },
      { key: "logistics_grid", label: "Logistics Grid", type: "object", required: false, width: "full" },
      { key: "disclaimers", label: "Disclaimers", type: "array", required: false, width: "full" },
      { key: "prepared_by", label: "Prepared By", type: "text", required: true, width: "half" },
      { key: "reviewed_and_approved_by", label: "Reviewed & Approved By", type: "text", required: true, width: "half" },
    ],
  },
  {
    code: "F/14",
    ...
    fields: [
      { key: "serial", label: "Serial Number", type: "text", required: true, width: "half", defaultValue: "auto" },
      { key: "date", label: "Date", type: "date", required: true, width: "half" },
      { key: "indent_no", label: "Indent No.", type: "text", required: false, width: "half" },
      { key: "items", label: "Items", type: "table", columns: [
        { key: "date", label: "Date", type: "text" },
        { key: "itemDescription", label: "Item Description", type: "text", required: true },
        { key: "qty", label: "Qty.", type: "text" },
        { key: "supplier", label: "Name Of Supplier", type: "text", required: true },
        { key: "inspectionStatus", label: "Inspection Status", type: "text" },
        { key: "inspectedBy", label: "Inspected By", type: "text" },
      ]},
      { key: "disclaimer", label: "Disclaimer", type: "textarea", required: false, width: "full" },
      { key: "prepared_by", label: "Prepared By", type: "text", required: true, width: "half" },
      { key: "checked_by", label: "Checked By", type: "text", required: true, width: "half" },
    ],
  },
  {
    code: "F/15",
  ...
  // ── Section 06: R&D & Design ──────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { key: "from_department", label: "From Department", type: "text", required: true, width: "half" },
      { key: "to_department", label: "To Department", type: "text", required: true, width: "half" },
      { key: "request_type", label: "Request Type", type: "text", required: true, width: "full" },
      { key: "customer_name", label: "Customer Name", type: "text", required: true, width: "half" },
      { key: "product_name", label: "Product Name", type: "text", required: true, width: "half" },
      { key: "specification", label: "Specification / Standard", type: "textarea", required: true, width: "full" },
      { key: "product_code", label: "Product Code", type: "text", required: false, width: "half" },
      { key: "sample_enclosed", label: "Sample Enclosed", type: "text", required: false, width: "half" },
      { key: "manufacturer", label: "Manufacturer", type: "text", required: false, width: "half" },
      { key: "present_market", label: "Present Market", type: "text", required: false, width: "half" },
      { key: "reason_for_development", label: "Reason for Development", type: "textarea", required: true, width: "full" },
      { key: "design_input_details", label: "Design Input Details", type: "textarea", required: true, width: "full" },
      { key: "target_completion", label: "Target Completion", type: "text", required: true, width: "half" },
      ...
      { key: "feasibility", label: "Feasibility", type: "text", required: false, width: "half" },
      { key: "rejection_reason", label: "Rejection Reason", type: "textarea", required: false, width: "full" },
      { key: "project_no", label: "Project No.", type: "text", required: false, width: "half" },
      { key: "priority", label: "Priority", type: "text", required: false, width: "half" },
      { key: "rd_target_completion", label: "R&D Target Completion", type: "text", required: false, width: "half" },
      { key: "assigned_to", label: "Assigned To", type: "text", required: false, width: "half" },
      { key: "rd_remarks", label: "R&D Remarks", type: "textarea", required: false, width: "full" },
      { key: "approved_by", label: "Approved By", type: "signature", required: false, width: "half" },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      { key: "serial", label: "Serial Number", type: "text", required: true, width: "half", defaultValue: "auto" },
      { key: "date", label: "Date", type: "date", required: true, width: "half" },
      { key: "product_name", label: "Product / Project Name", type: "text", required: true, width: "half" },
      ...
      { key: "objective", label: "Object And Variables", type: "textarea", required: true, width: "full" },
      { key: "experiments", label: "Experiments", type: "table", columns: [
        { key: "quantity", label: "Quantities", type: "text", required: true },
        { key: "description", label: "Description", type: "text", required: true },
        { key: "observation", label: "Observation / Results", type: "text", required: true },
      ]},
      { key: "conclusion", label: "Conclusion", type: "textarea", required: true, width: "full" },
