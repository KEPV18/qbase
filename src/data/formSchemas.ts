...
export const FORM_SCHEMAS: FormSchema[] = [
  ...
  // ── Section 02: Operations & Production ───────────────────────────────
  {
    ...
    frequency: "Monthly",
    importance: "Critical",
    description: "Monthly production plan covering all active projects with 7-column product tracking matrix.",
    fields: [
      { key: "serial", label: "Serial Number", type: "text", required: true, width: "half", defaultValue: "auto" },
      ...
      { key: "items", label: "Products", type: "table", required: true, columns: [
        { key: "product", label: "Product", type: "text", required: true },
        { key: "batch_no", label: "Batch No.", type: "text" },
        { key: "plan_date", label: "Plan Date", type: "text" },
        { key: "plan_size", label: "Plan Size", type: "text" },
        { key: "actual_date", label: "Actual Date", type: "text" },
        { key: "actual_qty", label: "Actual Qty", type: "text" },
        { key: "yield_percent", label: "% Yield", type: "text" },
      ]},
      { key: "remarks", label: "Remarks", type: "textarea", width: "full" },
      ...
      { key: "signature", label: "Signature / Date", type: "signature", required: true, width: "half" },
      { key: "updated_based_on_progress", label: "Updated Based On Progress", type: "text", width: "half" },
    ],
  },
  {
    code: "F/19",
  ...
  // ── Section 05: HR & Training ─────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { key: "attendees", label: "Attendees", type: "table", required: true, columns: [
        ...
        { key: "id_no", label: "ID NO.", type: "text" },
        { key: "date", label: "Training Date", type: "text" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "evaluation_matrix", label: "Evaluation Matrix", type: "array", required: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "project_scope", label: "Project Scope", type: "text", width: "full" },
      { key: "items", label: "Gap Analysis Items", type: "array", required: true },
      { key: "reviewed_by", label: "Reviewed By", type: "text", width: "half" },
      { key: "reviewed_on", label: "Reviewed On", type: "text", width: "half" },
      { key: "prepared_by", label: "Prepared By", type: "signature", required: true, width: "half" },
      { key: "authorised_by", label: "Authorised By", type: "signature", width: "half" },
      { key: "training_topics", label: "Training Topics", type: "array" },
      { key: "training_given", label: "Training Given", type: "array" },
    ],
  },
  {
    code: "F/42",
    ...
    fields: [
      ...
      { key: "project_scope", label: "Project Scope", type: "text", width: "full" },
      { key: "items", label: "Training Program Items", type: "array", required: true },
      { key: "prepared_by", label: "Prepared By", type: "signature", required: true, width: "half" },
  ...
  {
    code: "F/43",
    name: "Induction Training Form",
    section: 5,
    sectionName: "HR & Training",
    frequency: "Per new hire",
    importance: "Critical",
    description: "Onboarding induction training form with 15-topic checklist and effectiveness evaluation.",
    fields: [
      { key: "serial", label: "Serial Number", type: "text", required: true, width: "half", defaultValue: "auto" },
      { key: "date", label: "Training Date", type: "text", required: true, width: "half" },
      { key: "employee_name", label: "Employee Name", type: "text", required: true, width: "half" },
      { key: "employee_id", label: "Employee ID", type: "text", required: true, width: "half" },
      { key: "designation", label: "Designation", type: "text", required: true, width: "half" },
      ...
      { key: "trainer", label: "Trainer", type: "text", required: true, width: "half" },
      { key: "trainer_signature", label: "Trainer Signature", type: "text", width: "half" },
      { key: "manager_signature", label: "Authorised Person Signature", type: "text", width: "half" },
      { key: "effectiveness", label: "Effectiveness on Training", type: "text", required: true, width: "full" },
    ],
  },
  {
    code: "F/44",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "month", label: "Month", type: "select", required: true, options: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], width: "third" },
      { key: "year", label: "Year", type: "number", required: false, width: "third" },
      { key: "items", label: "Design Monitoring Items", type: "table", columns: [
        { key: "product_name", label: "Product Name", type: "text", required: true },
        { key: "specification", label: "Specification", type: "text", required: true },
        { key: "new_specification", label: "New Specification", type: "text", required: true },
        { key: "customer", label: "Name of the Customer", type: "text", required: true },
        { key: "reason", label: "Reason of Development", type: "text", required: true },
        { key: "dev_completion_date", label: "Dev Completion Date", type: "text", required: true },
        { key: "actual_completion_date", label: "Actual Completion Date", type: "text", required: true },
        { key: "rejection_reason", label: "Reason for Rejection", type: "text", required: false },
        { key: "action_taken", label: "Action Taken", type: "text", required: true },
        { key: "status", label: "Status", type: "text", required: true },
        { key: "design_head_sign", label: "Design Head Sign", type: "text", required: true },
      ]},
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "records", label: "Record Entries", type: "table", columns: [
        ...
        { key: "title", label: "Title Of Record", type: "text", required: true },
        { key: "format_no", label: "Format No. (If Any)", type: "text", required: true },
        { key: "frequency", label: "Frequency Of Collection", type: "text", required: true },
        { key: "method_of_filing", label: "Method Of Filing", type: "text", required: true },
        { key: "access", label: "Access", type: "text", required: true },
        { key: "storage_place", label: "Storage Place", type: "text", required: true },
        { key: "retention_period", label: "Retention Period", type: "text", required: true },
        { key: "person_responsible", label: "Person Responsible", type: "text", required: true },
      ]},
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "objectives", label: "Objectives", type: "table", columns: [
        { key: "criteria", label: "Quantifiable Criteria / Control Parameters", type: "text", required: true },
        { key: "present_target", label: "Present Target", type: "text" },
        { key: "future_target", label: "Future Target", type: "text" },
        { key: "program", label: "Program to achieve Objective", type: "textarea" },
        { key: "results", label: "Results for the month", type: "textarea" },
      ]},
      { key: "prepared_by", label: "Prepared By", type: "signature", required: true, width: "half" },
      { key: "reviewed_by", label: "Reviewed By", type: "signature", required: true, width: "half" },
    ],
  },
  {
    ...
    fields: [
      { key: "serial", label: "Serial Number", type: "text", required: true, width: "half", defaultValue: "auto" },
      { key: "date", label: "Date", type: "date", required: true, width: "half" },
      { key: "last_updated_by", label: "Last Updated By", type: "text", required: true, width: "half" },
      { key: "update_date", label: "Update Date", type: "date", required: true, width: "half" },
      { key: "documents", label: "Document Entries", type: "table", columns: [
        { key: "sr", label: "Sr.", type: "text", required: true },
        { key: "title", label: "Title of Document", type: "text", required: true },
        { key: "doc_number", label: "Document Number", type: "text", required: true },
        { key: "current_revision", label: "Current Revision", type: "text" },
        { key: "revision_date", label: "Revision Date", type: "text" },
        { key: "revision_details", label: "Revision Details", type: "text" },
      ]},
      { key: "disclaimer", label: "Disclaimer", type: "textarea" },
      { key: "distribution", label: "Distribution List", type: "table", columns: [
        { key: "sr", label: "Sr.", type: "text" },
        { key: "name", label: "Name", type: "text" },
        { key: "copy_no", label: "Copy No.", type: "text" },
      ]},
      { key: "maintained_by", label: "Maintained By", type: "signature", required: true, width: "half" },
    ],
  },
  {
    ...
    fields: [
      { key: "serial", label: "Serial Number", type: "text", required: true, width: "half", defaultValue: "auto" },
      { key: "date", label: "Date Prepared", type: "date", required: true, width: "half" },
      { key: "requested_by", label: "Requested By", type: "text", required: true, width: "half" },
      { key: "designation", label: "Designation", type: "text", required: true, width: "half" },
      { key: "department", label: "Department", type: "text", required: true, width: "half" },
      { key: "location", label: "Location", type: "text", width: "half" },
      { key: "description", label: "Description of Proposed Change", type: "textarea", required: true, width: "full" },
      { key: "reason", label: "Reason for Proposed Change", type: "textarea", required: true, width: "full" },
      { key: "change_type", label: "Type of Proposed Change", type: "text", required: true, width: "half" },
      { key: "priority", label: "Change Priority", type: "text", required: true, width: "third" },
      { key: "impact", label: "Change Impact", type: "text", required: true, width: "third" },
      { key: "impact_description", label: "Impact Description", type: "textarea", width: "full" },
      { key: "resources", label: "Resources Required", type: "textarea", width: "full" },
      { key: "approval_status", label: "Top Management Decision", type: "text", required: true, width: "half" },
      { key: "approved_by", label: "Approved By", type: "signature", width: "half" },
      { key: "implementation_date", label: "Target Date for Implementation", type: "date", width: "half" },
      { key: "follow_up", label: "Implementation and Follow-Up", type: "textarea", width: "full" },
      { key: "actual_completion_date", label: "Actual Completion Date", type: "date", width: "half" },
      { key: "verified_by", label: "Verified By", type: "text", width: "half" },
