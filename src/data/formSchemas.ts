...
export const FORM_SCHEMAS: FormSchema[] = [
  ...
  // ── Section 04: Procurement & Vendors ─────────────────────────────────
  {
    ...
    fields: [
      { key: "serial", label: "Serial Number", type: "text", required: true, width: "half", defaultValue: "auto" },
      { key: "date", label: "Date", type: "date", required: true, width: "half" },
      { key: "purchase_order_no", label: "Purchase Order No.", type: "text", required: false, width: "half" },
      { key: "to", label: "To (Supplier)", type: "text", required: true, width: "full" },
      { key: "items", label: "Items", type: "table", columns: [
        { key: "sr_no", label: "Sr. No.", type: "text" },
        { key: "description", label: "Description", type: "text", required: true },
        { key: "quantity", label: "Quantity", type: "text" },
      ]},
      { key: "total_amount", label: "Total Amount", type: "text", required: false, width: "half" },
      { key: "specifications", label: "Specifications", type: "textarea", required: false, width: "full" },
      { key: "note", label: "Note", type: "textarea", required: false, width: "full" },
      { key: "delivery_period", label: "Delivery Period", type: "text", required: false, width: "half" },
      { key: "payment_terms", label: "Payment Terms", type: "text", required: false, width: "half" },
      { key: "mode_of_despatch", label: "Mode of Despatch", type: "text", required: false, width: "half" },
      { key: "despatch_arrangement", label: "Despatch Arrangement", type: "text", required: false, width: "half" },
      { key: "method_of_product_approval", label: "Method of Product Approval", type: "textarea", required: false, width: "full" },
      { key: "requirement_of_test_certificate", label: "Requirement of Test Certificate", type: "text", required: false, width: "half" },
      { key: "insurance", label: "Insurance", type: "text", required: false, width: "half" },
      { key: "despatch_destination", label: "Despatch Destination", type: "text", required: false, width: "half" },
      { key: "terms_and_conditions", label: "Terms & Conditions", type: "textarea", required: false, width: "full" },
      { key: "prepared_by", label: "Prepared By", type: "text", required: true, width: "half" },
      { key: "approved_by", label: "Reviewed And Approved By", type: "text", required: true, width: "half" },
    ],
  },
  {
    code: "F/14",
