...
export function F09Template({ data, isTemplate = true, editMode = false, onChange, className }: F09Props) {
  ...
  const inp = (key: string, placeholder?: string, width?: string) => {
    ...
    return (
      <input className={`w-full bg-transparent text-sm outline-none border-0 border-b border-gray-300 dark:border-gray-600 px-1 py-0.5 ${width || ""}`}
  ...
  const textarea = (key: string, placeholder?: string, rows = 3) => {
    ...
    return (
      <textarea className="w-full bg-transparent text-sm outline-none border border-gray-300 dark:border-gray-600 rounded-sm px-1 py-0.5 resize-y"
    ...
    <div className={cn("overflow-x-auto", className)}>
      <table className="w-full border-collapse border border-gray-400 dark:border-gray-600">
        ...
        <tbody>
          ...
          <tr>
            <td colSpan={11} className="border border-gray-400 dark:border-gray-600 px-3 py-2 text-center font-bold text-sm text-gray-900 dark:text-gray-100">
          ...
          <tr>
            <td rowSpan={2} className="border border-gray-400 dark:border-gray-600 px-2 py-2 text-sm font-semibold text-gray-900 dark:text-gray-100 align-middle">
              Receipt of Complaint
            </td>
            <td colSpan={3} className="border border-gray-400 dark:border-gray-600 px-2 py-1.5 text-sm font-semibold text-gray-900 dark:text-gray-100">
              Date
            </td>
            <td colSpan={3} className="border border-gray-400 dark:border-gray-600 px-2 py-1.5 text-sm">
              {inp("receipt_date", "DD/MM/YYYY")}
            </td>
            <td rowSpan={2} colSpan={2} className="border border-gray-400 dark:border-gray-600 px-2 py-2 text-sm font-semibold text-gray-900 dark:text-gray-100 align-middle">
              Received By 🡪
            </td>
            <td rowSpan={2} colSpan={3} className="border border-gray-400 dark:border-gray-600 px-2 py-2 text-sm">
          ...
          <tr>
            ...
            <td colSpan={5} className="border border-gray-400 dark:border-gray-600 px-3 py-1.5 text-sm">
            </td>
          </tr>

          {/* ROW 5: Customer Name */}
          <tr>
            <td colSpan={12} className="border border-gray-400 dark:border-gray-600 px-3 py-1.5 text-sm text-gray-900 dark:text-gray-100">
          ...
          <tr>
            <td colSpan={12} className="border border-gray-400 dark:border-gray-600 px-3 py-1.5 text-sm font-semibold text-gray-900 dark:text-gray-100">
              Details of Product
            </td>
          </tr>
          ...
          <tr>
            ...
            <td colSpan={10} className="border border-gray-400 dark:border-gray-600 px-3 py-1.5 text-sm">
          ...
          <tr>
            <td colSpan={12} className="border border-gray-400 dark:border-gray-600 px-3 py-1">
          ...
          <tr>
            <td colSpan={3} className="border border-gray-400 dark:border-gray-600 px-3 py-1.5 text-sm font-semibold text-gray-900 dark:text-gray-100">
              Nature Of Complaints 🡪
            </td>
            <td colSpan={3} className="border border-gray-400 dark:border-gray-600 px-3 py-1.5 text-sm font-semibold text-gray-900 dark:text-gray-100 text-center">
              SERIOUS
            </td>
            <td colSpan={3} className="border border-gray-400 dark:border-gray-600 px-3 py-1.5 text-sm font-semibold text-gray-900 dark:text-gray-100 text-center">
              MAJOR
          ...
          <tr>
            <td colSpan={3} className="border border-gray-400 dark:border-gray-600"></td>
            <td colSpan={3} className="border border-gray-400 dark:border-gray-600 text-center py-2">
              {editMode && !isTemplate ? (
          ...
          <tr>
            <td colSpan={5} className="border border-gray-400 dark:border-gray-600 px-3 py-1.5 text-sm font-semibold text-gray-900 dark:text-gray-100">
              Result Of Action Taken
            </td>
            <td colSpan={7} className="border border-gray-400 dark:border-gray-600 px-3 py-1.5 text-sm font-semibold text-gray-900 dark:text-gray-100">
              Actions Proposed For Future
            </td>
          </tr>
          <tr>
            <td colSpan={5} className="border border-gray-400 dark:border-gray-600 px-2 py-1 min-h-[4rem]">
              {textarea("result_of_action", "", 2)}
            </td>
            <td colSpan={7} className="border border-gray-400 dark:border-gray-600 px-2 py-1 min-h-[4rem]">
          ...
          <tr>
            <td colSpan={5} className="border border-gray-400 dark:border-gray-600"></td>
            <td colSpan={2} className="border border-gray-400 dark:border-gray-600 px-2 py-1.5 text-sm font-semibold text-gray-900 dark:text-gray-100">
              Customer Informed Vide
            </td>
            <td colSpan={5} className="border border-gray-400 dark:border-gray-600 px-2 py-1.5 text-sm">
          ...
          <tr>
            <td colSpan={5} className="border border-gray-400 dark:border-gray-600"></td>
            <td colSpan={7} className="border border-gray-400 dark:border-gray-600 px-2 py-1.5 text-sm">
          ...
          {/* VEZLOO footer */}
          <tr>
            <td colSpan={12} className="text-center text-[10px] font-bold text-gray-400 py-1 border border-gray-400 dark:border-gray-600">
              VEZLOO
            </td>
          </tr>
        </tbody>
