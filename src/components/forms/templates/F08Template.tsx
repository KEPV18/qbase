  ...
  return (
    <div className={cn("w-full", className)}>
      ...
      <div className="hidden md:block">
        ...
        <table className="w-full border-collapse border border-border dark:border-gray-700">
          ...
          <tbody>
            ...
            <tr>
              <td colSpan={13} className="border border-border dark:border-gray-700 px-3 py-2 text-center">
              ...
              <td className="border border-border dark:border-gray-700 px-2 py-1 text-[10px] text-gray-500 dark:text-gray-400 text-center leading-tight">
            ...
            {/* ROW 1: Sr. No. + Date */}
            <tr>
              <td colSpan={8} className="border border-border dark:border-gray-700 px-3 py-1.5 text-sm text-gray-900 dark:text-gray-100">
                <strong>Sr. No.</strong> 🡪&nbsp;&nbsp;{serialValue}
              </td>
              <td colSpan={6} className="border border-border dark:border-gray-700 px-3 py-1.5 text-sm text-gray-900 dark:text-gray-100">
            ...
            {/* ROW 2: Customer */}
            <tr>
              <td colSpan={2} className="border border-border dark:border-gray-700 px-3 py-1.5 text-sm font-semibold text-gray-900 dark:text-gray-100">
                Customer
              </td>
              <td colSpan={1} className="border border-border dark:border-gray-700"></td>
              <td colSpan={11} className="border border-border dark:border-gray-700 px-3 py-1.5 text-sm text-gray-900 dark:text-gray-100">
                {val(d, "client_name") || "--"}
              </td>
            </tr>
            ...
            <tr>
              <td colSpan={1} className="border border-border dark:border-gray-700 px-2 py-1.5 text-sm font-semibold text-gray-900 dark:text-gray-100">
                Sr. No.
              </td>
              <td colSpan={3} className="border border-border dark:border-gray-700 px-2 py-1.5 text-sm font-semibold text-gray-900 dark:text-gray-100">
                Product Name
              </td>
              <td colSpan={7} className="border border-border dark:border-gray-700 px-2 py-1.5 text-sm font-semibold text-gray-900 dark:text-gray-100">
                Specifications
              </td>
              <td colSpan={3} className="border border-border dark:border-gray-700 px-2 py-1.5 text-sm font-semibold text-gray-900 dark:text-gray-100">
                Qty.
            ...
            {items.map((item, idx) => (
              <tr key={idx}>
                <td className="border border-border dark:border-gray-700 px-2 py-1.5 text-sm text-gray-900 dark:text-gray-100 text-center">
                  {editMode ? (
                    <input className="w-full text-xs px-1 py-0.5 bg-transparent border-0 border-b border-border dark:border-gray-600 focus:outline-none text-center"
                      value={idx + 1} disabled />
                  ) : (
                    idx + 1
                  )}
                </td>
                <td colSpan={3} className="border border-border dark:border-gray-700 px-2 py-1.5 text-sm">
                  {editMode ? (
                    <input className="w-full text-xs px-1 py-0.5 bg-transparent border-0 border-b border-border dark:border-gray-600 focus:outline-none"
                ...
                <td colSpan={7} className="border border-border dark:border-gray-700 px-2 py-1.5 text-sm">
                  {editMode ? (
                    <input className="w-full text-xs px-1 py-0.5 bg-transparent border-0 border-b border-border dark:border-gray-600 focus:outline-none"
            ...
            {editMode && (
              <tr>
                <td colSpan={14} className="border border-border dark:border-gray-700 px-2 py-1">
            ...
            <tr>
              <td colSpan={5} className="border border-border dark:border-gray-700 px-3 py-1.5 text-sm font-semibold text-gray-900 dark:text-gray-100">
                Requirement Of Test Certificate
              </td>
              <td colSpan={2} className="border border-border dark:border-gray-700"></td>
              <td colSpan={7} className="border border-border dark:border-gray-700 px-3 py-1.5 text-sm text-gray-900 dark:text-gray-100">
                {editMode ? (
                  <input className="w-full text-xs px-1 py-0.5 bg-transparent border-0 border-b border-border dark:border-gray-600 focus:outline-none"
            ...
            <tr>
              <td colSpan={8} className="border border-border dark:border-gray-700 px-3 py-1.5 text-sm text-gray-900 dark:text-gray-100 whitespace-pre-wrap">
            ...
            <tr>
              ...
              <td colSpan={1} className="border border-border dark:border-gray-700"></td>
              <td colSpan={3} className="border border-border dark:border-gray-700 px-3 py-1.5 text-sm text-gray-900 dark:text-gray-100">
                {val(d, "bill_no") || "N/A"}
              </td>
              <td colSpan={3} className="border border-border dark:border-gray-700 px-3 py-1.5 text-sm text-gray-500 dark:text-gray-400">
            ...
            <tr>
              ...
              <td colSpan={3} className="border border-border dark:border-gray-700"></td>
              <td colSpan={1} className="border border-border dark:border-gray-700"></td>
              <td colSpan={2} className="border border-border dark:border-gray-700"></td>
              <td colSpan={2} className="border border-border dark:border-gray-700"></td>
            </tr>
      ...
      <div className="block md:hidden space-y-2">
        <div className="border border-border dark:border-gray-700 rounded-sm p-3 text-center">
          <span className="text-2xl font-bold tracking-widest">VEZLOO</span>
        </div>
        <div className="border border-border dark:border-gray-700 rounded-sm p-3 text-center text-sm">
          <strong>Order Form / Order Confirmation</strong>
          <div className="text-xs text-muted-foreground mt-1">{serialValue}</div>
        </div>
        <div className="border border-border dark:border-gray-700 rounded-sm p-3 space-y-2">
        ...
        {items.map((item, idx) => (
          <div key={idx} className="border border-border dark:border-gray-700 rounded-sm p-3 space-y-1">
        ...
        <div className="border border-border dark:border-gray-700 rounded-sm p-3 space-y-1 text-xs">
