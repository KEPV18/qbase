        ...
        <table className="w-full border-collapse text-[10px]">
          <thead>
            <tr className="bg-muted">
              ...
              <th className="border border-border p-1" rowSpan={2}>Designation</th>
              ...
              <th className="border border-border p-1" colSpan={2}>Skill</th>
              <th className="border border-border p-1" colSpan={5}>Type of Training Required</th>
              {editMode && <th className="border border-border p-1 w-[24px]" rowSpan={2}></th>}
            </tr>
            <tr className="bg-muted">
              <th className="border border-border p-1 text-[9px]">Req.</th>
              <th className="border border-border p-1 text-[9px]">Avail.</th>
              <th className="border border-border p-1 text-[9px]">Req.</th>
              <th className="border border-border p-1 text-[9px]">Avail.</th>
              <th className="border border-border p-1 text-[9px]">Req.</th>
              <th className="border border-border p-1 text-[9px]">Avail.</th>
